...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
     if (request.message === 'TabUpdated') {
          ...
          if (document.location.href.indexOf("/orders/") > -1 || document.location.href.includes("/orders/")) {
               console.log("::: ORDERS (2)")

               window.addEventListener('DOMContentLoaded', function () {
                    console.log("::: ORDERS (2 DOMContentLoaded)")
                    checkExistsClass();
                });
               ...
               setTimeout(() => {
                    checkExistsClass();
                    myFunction();
                    console.log("::: Executed myFunction after timeout! (2)");
               }, 1000);
          }
     }
})
